...
const SignIn: React.FC = () => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      await axios.post('http://localhost:5004/user/login', {
        email,
        password
      }).then((response) => {
        console.log(response.data._doc);
        sessionStorage.setItem("hackathonUser", JSON.stringify(response.data));
        setTimeout(() => {
          navigate('/');
        }, 1000)
      }
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark  h-screen">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-4 px-26 text-center">
              <div className="mb-2 inline-block">
                <img className="hidden dark:block w-20 h-20" src={LogoIcon} alt="Logo" />
                <img className="dark:hidden w-40 h-36" src={LogoIcon} alt="Logo" />
              </div>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mb-4  xl:hidden w-full  pr-8">
                <img className="hidden dark:block w-20 h-20 mx-auto" src={LogoIcon} alt="Logo" />
                <img className="dark:hidden w-40 h-36  mx-auto" src={LogoIcon} alt="Logo" />
              </div>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign In to Reproute360
              </h2>
