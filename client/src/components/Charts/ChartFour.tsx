...
const ChartFour: React.FC = () => {
    const [state, setState] = useState({
        series: [
            {
                name: 'Total Visits',
                data: [10, 12, 8, 13, 11], // Total visits data for each month
                type: 'bar', // Specify this series as a bar chart
            },
            {
                name: 'No-shows',
                data: [2, 1, 1, 3, 2], // No-shows data for each month
                type: 'bar', // Specify this series as a bar chart
            },
            {
                name: 'No-show Rate',
                data: [20, 8, 12.5, 23, 18], // No-show rate in percentage for each month
                type: 'line', // Specify this series as a line chart
            },
        ],
                ...
                <div className="flex w-full flex-wrap gap-3 sm:gap-5">
                    <div className="flex min-w-47.5">
                        ...
                        <div className="w-full">
                            <p className="font-semibold text-primary">No-Show Frequency</p>
